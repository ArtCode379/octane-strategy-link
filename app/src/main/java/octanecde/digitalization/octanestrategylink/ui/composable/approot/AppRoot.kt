package octanecde.digitalization.octanestrategylink.ui.composable.approot
...
import octanecde.digitalization.octanestrategylink.ui.composable.navigation.AppNavHost
import octanecde.digitalization.octanestrategylink.ui.composable.navigation.NavRoute
import kotlin.reflect.KClass

private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.pptkn_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home
    ),
    BottomNavItem(
        titleRes = R.string.pptkn_bottom_bar_nav_item_bookings_title,
        icon = Icons.Default.Book,
        route = NavRoute.Bookings
    ),
    BottomNavItem(
        titleRes = R.string.pptkn_bottom_bar_nav_item_settings_title,
