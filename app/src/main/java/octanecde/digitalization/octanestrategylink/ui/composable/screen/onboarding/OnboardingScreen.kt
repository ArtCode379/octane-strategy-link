...
private val onboardingPagesContent = listOf<OnboardingContent>(
    OnboardingContent(
        titleRes = R.string.pptkn_page_1_title,
        descriptionRes = R.string.pptkn_page_1_description,
        imageRes = R.drawable.pptkn_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.pptkn_page_2_title,
        descriptionRes = R.string.pptkn_page_2_description,
        imageRes = R.drawable.pptkn_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.pptkn_page_2_title,
