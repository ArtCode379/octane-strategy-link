Fix the Android project at /tmp/octane-strategy-link so the failing quality-fix-1 step passes.
...
Recent failure log:
```text
=== QUALITY CHECK: /tmp/octane-strategy-link ===
...
0: integer expression expected
  OK: Repository: 0
0 entries
  PLACEHOLDER-LIKE: app/src/main/res/drawable/service_1.jpg (colors=36770, entropy=0.671409)
...
FAIL: 2 placeholder-like drawable image(s); use real photos or filesystem-backed imagegen output, not local generated placeholders
  ...
  OK: icon.png (258855B, 512x512, rounded opaque canvas, transparent corners)
  OK: Application class ServiceApplication exists
  OK: HomeScreen.kt: 267 lines
