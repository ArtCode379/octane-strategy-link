Generate and install the app icon for /tmp/octane-strategy-link.
...
/tmp/octane-strategy-link/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/octane-strategy-link/app/src/main/res/drawable/icon.png`.
